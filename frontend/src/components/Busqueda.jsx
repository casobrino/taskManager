  ...
  const proyectosFiltrados =
    busqueda === ""
      ...
      : proyectos.filter((proyecto) =>
          proyecto.name.toLowerCase().includes(busqueda.toLowerCase())
        );
  return (
    <Transition.Root
      show={buscador}
            ...
            <div className="relative">
              <div className="flex flex-row">
                <Combobox.Input
                  ...
                  placeholder="Buscar..."
                  onBlur={handleBuscador}
                  onChange={(e) => setBusqueda(e.target.value)}
                />
                <button
                  type="button"
                  className="px-1 w-[30px] h-[30px] align-center my-auto mx-2 bg-red-600 text-white rounded-[50%]"
